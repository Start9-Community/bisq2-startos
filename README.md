...
code (with a scannable QR) as a service **Property** and a small web UI.

> **Scope:** this packages the **headless trusted node** for Bisq Connect — not the
> full Bisq 2 desktop application. The web UI is a pairing/status page, not the desktop app.
